...
internal static class ReleasesParserTools
{
    ...
    public record PositionCheckResultAndDateTime(
    ...
    /// <returns></returns>
    public static PositionCheckResultAndDateTime Check(string releaseDate, int correctYear, int fromMonth,
        int toMonth)
    {
        ...
        if (exactDate != null)
        {
            ...
            return PositionCheckResultAndDateTime.FromMonthAndDateOfMonth(exactDate.Value.Month,
                exactDate.Value.Day);
        }
